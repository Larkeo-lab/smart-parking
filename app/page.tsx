...
export default function SmartParkingPage() {
  ...
  const [parkingSpots] = useState<Record<string, Spot[]>>(initialSpots);
  const [searchTerm] = useState("");

  useEffect(() => {
    setMalls((prevMalls: Mall[]) =>
      prevMalls.map((mall: Mall) => {
